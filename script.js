...
function checkWin() {
  ...
  for (let i = 0; i < winConditions.length; i++) {
    const v0 = boxes[winConditions[i][0]].innerHTML; // Confere a first caixa
    const v1 = boxes[winConditions[i][1]].innerHTML; // Confere a second caixa
    const v2 = boxes[winConditions[i][2]].innerHTML; // Confere a third caixa
    //verifica se as caixas marcadas tem o mesmo valor
    if (v0 != "" && v0 === v1 && v0 === v2) {
      haveWinner = true;
      turnDisplay.setAttribute("hidden", true);
